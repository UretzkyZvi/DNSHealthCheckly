class ThresholdValidator {
  ...
  /**
   * Updates the thresholds with new values.
   * @param {Object} newThresholds - The new threshold values.
   * @returns {void}
   **/
  ...
  validateResponseTime(responseTime) {
    console.log(`Validating response time: ${responseTime}`);
    console.log(`Threshold: ${this.thresholds.responseTime}`);
